        ...
        <div class="side">
            ...
            <form class="contcontrol" method="POST" action="adm.php">
                <div class="tside">
                    ...
                    <textarea name="mens" class="mens" cols="30" rows="7" <?php if ($row['voteg'] == 1) {
        ...
        <div class="i">
            ...
            <form action="adm.php" method="POST"  class="form" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <br>            
                        <textarea name="sinopse" class="campo" cols="30" rows="4" style="resize: none;"><?php echo $row["sinopse"]; ?></textarea>
                    </div>
                    ...
                    <div class="envb">
                        <button type="submit" name="catalogo">Validar</button>
                        <button type="submit" name="apagar" style="background-color: var(--or); margin-right:10px;" >Apagar</button>
                    </div>
